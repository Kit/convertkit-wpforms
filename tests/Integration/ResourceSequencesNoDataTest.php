...
/**
 * Tests for the Integrate_ConvertKit_WPForms_Resource_Sequences class when no data is present in the API.
 *
 * @since   1.8.9
 */
class ResourceSequencesNoDataTest extends \Codeception\TestCase\WPTestCase
{
	 ...
	 * @since   1.8.9
	 *
	 * @var     Integrate_ConvertKit_WPForms_Resource_Sequences
	 */
	private $resource;
	...
	public function setUp(): void
	{
		...
		require_once 'includes/class-integrate-convertkit-wpforms-resource-sequences.php';
		...
		$this->resource = new \Integrate_ConvertKit_WPForms_Resource_Sequences( $this->api, $this->wpforms_account_id );
